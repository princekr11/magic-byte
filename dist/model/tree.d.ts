...
export declare const createNode: (typename: string, bytes: string[], info?: Info) => NewNode;
export declare const createComplexNode: (typename: string, bytes: string[], info?: Info) => Node;
