...
const walkTree = (index, bytes, node) => {
    ...
    let guessFile = [];
    while (true) {
        const currentByte = (0, toHex_1.toHex)(bytes[index]);
...
const filetypename = (bytes) => (0, exports.filetypeinfo)(bytes).map((e) => e.typename);
exports.filetypename = filetypename;
const filetypemime = (bytes) => (0, exports.filetypeinfo)(bytes).map((e) => (e.mime ? e.mime : ""));
exports.filetypemime = filetypemime;
const filetypeextension = (bytes) => (0, exports.filetypeinfo)(bytes).map((e) => (e.extension ? e.extension : ""));
